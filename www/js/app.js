...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	mounted: function mounted() {
		...
		navigator.notification.confirm('It works!', null, 'Native notification', ['OK', 'Cancel']);
		axios.get("https://api.coindesk.com/v1/bpi/currentprice.json").then(function (response) {
			_this.api = response.data.bpi.USD.code + " " + response.data.bpi.USD.rate;
		});
	}
});
        ...
        _c("div", { staticClass: "card" }, [
          ...
          _c("div", { staticClass: "card-body" }, [
            _c("p", { staticClass: "card-text" }, [
              _vm._v(
                "I'm an example component and current Bitcoin rate is " +
                  _vm._s(_vm.api) +
                  "."
              )
            ])
